...
<body style="background-color: black;">
	...
	<div class="container-fluid">
		...
		<a href="kelola_7.php" type="button" class="btn btn-primary mb-3">
		  ...
		  <table class="table align-middle table-bordered table-hover">
		    ...
		    ?>
		      <tr>
		        ...
		        <td>
		        	<a href="kelola_7.php?ubah=<?php echo $result['ID'];?>" type="button" class="btn btn-success btn-sm">
		        		<i class="fa fa-pencil"></i>
		        	</a>
		        	<a href="proses_7.php?hapus=<?php echo $result['ID'];?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure to delete this user?')"> 
